...
from combustion_ble import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "combustion_ble"
copyright = f"{datetime.today().year}, Larry Gregory"
...
html_title = f"combustion_ble v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/legrego/combustion_ble",
            "html": """
